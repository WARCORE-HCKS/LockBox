  ...
  const handleMessageReceived = useCallback(async (message: Message) => {
    ...
    if (
      ...
      try {
        ...
        // Use functional setState to access current messages and handle temp message replacement
        setMessages((prev) => {
          ...
          // If this is our own message, remove any temp message with matching recipient and timestamp
          if (message.senderId === currentUser?.id) {
